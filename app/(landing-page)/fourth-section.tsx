...
const tabs = [
  ...
  },
  {
    ...
    subheading:
      "Everything is customizable. Choose your own colors, icons, and more to make workspace work for you.",
  ...
  return (
    <>
      <div className="flex flex-col  pt-20 xl:py-32 items-center justify-center">
        ...
        >
          &quot;Workspace adapts to your needs. It&apos;s as minimal or as powerful
