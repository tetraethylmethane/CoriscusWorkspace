...
const FormSchema = z.object({
  ...
  help: z.enum([
    "Evaluate workspace for my company",
    "Learn More",
    "Get a Quote",
          ...
          <div
            className="
              ...
              text-gray-500
                    "
          >
            Let&apos;s talk about how workspace can help your team work better.
          </div>
...
<FormField
              ...
              render={({ field }) => (
                <FormItem className="items-center justify-center  w-full">
                  ...
                  >
                    ...
                    <SelectContent>
                      <div className="flex gap-4">
                        <SelectItem value="Evaluate workspace for my company">
                          Evaluate workspace for my company
                        </SelectItem>
                      </div>
                      <SelectItem value="Learn More">Learn More</SelectItem>
                      <SelectItem value="Get a Quote">Get a Quote</SelectItem>
                      <SelectItem value="How to use workspace">
                        How to use workspace
                      </SelectItem>
            ...
            <div className="flex gap-4 items-center">
              ...
              <div className="text-xs font-light  md:w-3/4 mb-1">
                I agree to workspace&apos; sending marketing communications related to workspace 
              </div>
            </div>
